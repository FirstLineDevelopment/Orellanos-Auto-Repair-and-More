...
- Location: Waterbury, based on Facebook metadata.
- Waterbury presence, based on Facebook metadata.
- Mopar master-tech claim appears on the business card, but exact credential wording should be confirmed before launch.
...
- Owner name
- Staff names
- Review ratings and review quotes
- Certifications, inspections, warranties, towing relationships, payment methods, or vehicle specialties
- Final logo and brand identity
- Permission to use Facebook/page imagery
